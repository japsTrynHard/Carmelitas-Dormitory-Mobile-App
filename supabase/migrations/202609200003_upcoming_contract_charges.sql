-- Future contract charges are scheduled but must not count as outstanding yet.
...
comment on column public.tenant_contracts.starts_on is
  'Inclusive contract start date; its day-of-month is the recurring monthly rent due day.';
